class Habilidade:
    def __init__(self, nome, tipo, dano, custo_mp, precisao, descricao, efeito=None, chance_efeito=0.0, em_area=False, verso=None):
        self.nome = nome
        self.tipo = tipo
        self.dano = dano              
...
banco_habilidades = {
    ...
    "Mordida": Habilidade(nome="Mordida", tipo="Físico", dano=6, custo_mp=0, precisao=0.95, descricao="Uma mordida."),
