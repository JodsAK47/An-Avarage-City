...
class GerenciadorPosLuta:
    def __init__(self, tela):
        ...
        self.mensagem = "Selecione um espaco para consultar seu conteudo."

        self.fonte_titulo = obter_fonte(34)
        self.fonte_secao = obter_fonte(20)
        self.fonte_texto = obter_fonte(16)
        self.fonte_menor = obter_fonte(12)
    ...
    def _retangulos_slots(self):
        ...
        equipamentos = [pygame.Rect(710 + coluna * 70, 535 + linha * 62, 52, 48)
        ...
        if evento.type == pygame.MOUSEBUTTONUP and evento.button == 1:
            ...
            for indice, slot in enumerate(inventario + equipamentos):
                if slot.collidepoint(posicao_mouse):
                    ...
                    self.mensagem = "Espaco vazio: pronto para receber um item."
                    return None
    ...
    def desenhar(self):
        ...
        for indice, jogador in enumerate(self.jogadores):
            rect = pygame.Rect(250 + indice * 135, 38, 120, 34)
        ...
        for indice in range(4):
            ...
            self.tela.blit(self.fonte_menor.render("disponivel futuramente", True, (125, 135, 150)), (82, rect.y + 34))
        self.tela.blit(self.fonte_menor.render("Sistema de criacao em preparacao", True, (150, 160, 175)), (68, 585))
