...
class GerenciadorJogo:
    def __init__(self, tela):
        ...
        # BOTÕES DA HUD 
        self.btn_ataque    = Botao(220, 640, 120, 50, "ATAQUE", (100,0,0), (150,0,0), 124, 54, cor_texto=(255,255,255), fonte_tamanho=16)
        self.btn_recuperar = Botao(360, 640, 120, 50, "RECUP", (0,100,0), (0,150,0), 124, 54, cor_texto=(255,255,255), fonte_tamanho=15)
        self.btn_bloquear  = Botao(500, 640, 120, 50, "BLOQ", (100,100,0), (150,150,0), 124, 54, cor_texto=(255,255,255), fonte_tamanho=15)
        self.btn_fugir     = Botao(640, 640, 120, 50, "FUGIR", (50,50,50), (100,100,100), 124, 54, cor_texto=(255,255,255), fonte_tamanho=16)
        self.btn_voltar    = Botao(640, 640, 120, 50, "VOLTAR", (80,80,80), (120,120,120), 124, 54, cor_texto=(255,255,255), fonte_tamanho=16)
    ...
    def gerar_botoes_ataque(self):
        ...
        for indice_habilidade, nome_habilidade in enumerate(personagem.ataques):
            ...
            botao_habilidade = Botao(posicao_x_botao, 640, 120, 50, nome_habilidade.upper()[:10], (0,100,150), (0,150,200), 124, 54, cor_texto=(255,255,255), fonte_tamanho=16)
