...
class Inimigo:
    ...
    def desenhar(self, tela):
        if self.hp > 0:
            ...
            fonte = pygame.font.SysFont(["consolas", "courier"], 14, bold=True)
...
def obter_inimigos_por_cenario(id_cenario):
    ...
    if id_cenario == "cenario_1":
        ...
        return [
            Inimigo(0, 0, 120, "Maldição1.png", "Senhor da Guerra", ["Porrete do Chefe", "Soco", "Flechada Letal"], 200, {"For": 8, "Agi": 4, "Int": 2})
        ]
