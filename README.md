...
No momento passando as informações pro read.me:

An Avarage City- uma aventura "misturiosa"
...
E: interagir 
MouseL/R: ações durante combate 

DURANTE O JOGO:
a luta inicia ao chegar no local determinado,durante a luta tanto o inimigo como o Protagonista terão ações de combate simples ou mais fortes que gastam energia.Voce perde se todos do time ficarem sem vida, e ganha caso derrote todos os inimigos antes disso
